...
def agent_designer(task: dict, spec: str) -> str:
    ...
    system = (
        "Ты Senior UI/UX Designer. Создай ПОЛНУЮ дизайн-систему: "
...
def agent_frontend(spec: str) -> str:
    """🎨 Frontend Developer: рисует ВСЕ экраны на одной HTML странице."""
    system = (
    ...
    return call_deepseek(system, f"Дизайн-система и список экранов:\n{spec[:55000]}", max_tokens=8000)
